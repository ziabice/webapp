...
/**
 * Un oggetto base per modellare oggetti che vengono salvati
...
*/
class EditableObject extends WebAppObject implements EditableObjectInterface {
	 ...
	 * @param mixed $creator NULL o l'uid del creatore (di solito un intero)
	*/
	public function __construct($id = NULL, $creator = NULL) {
		$this->creator_uid = $creator;
